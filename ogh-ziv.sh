...
# ════════════════════════════════════════════════════════════
#  CEK IZIN
#  Format daftar di GitHub:
#    label  YYYY-MM-DD  ip_vps   → ada expired
#    label  exp         ip_vps   → unlimited / selamanya
#
#  IP ada + belum expired = LOLOS
#  IP tidak ada           = BLOK
#  IP ada tapi expired    = BLOK
# ════════════════════════════════════════════════════════════
check_izin() {
    local R='\033[1;31m' Y='\033[1;33m' W='\033[1;37m' G='\033[1;32m' N='\033[0m'
    ...
    # ── Cek expired (hanya jika format tanggal YYYY-MM-DD) ──
    ...
    # ── LOLOS — simpan info untuk header panel ───────────
    IZIN_IP="$MY_IP"
    IZIN_LABEL="$M_LABEL"
    IZIN_EXP="$M_EXP"
}
...
draw_vps() {
    ...
    # Row: STATUS IZIN
    local _exp_disp="${IZIN_EXP}"
    local _exp_col="${LG}"
    # Jika bukan format tanggal (misal "exp" atau "unlimited") tampil hijau
