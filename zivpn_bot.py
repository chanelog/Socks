...
def write_default_config():
    ...
    if not p.exists():
        p.write_text(
            ...
            "# OWNER_ID = Chat ID Admin Utama (1 orang, akses penuh)\n"
            "OWNER_ID=ISI_CHAT_ID_OWNER\n\n"
            "# ADMIN_IDS = Semua admin (owner + reseller)\n"
            "# Owner otomatis masuk ke sini\n"
            "# Tambah reseller via bot atau tambahkan Chat ID di sini\n"
        ...
        print("[INFO] Edit file tersebut lalu jalankan kembali bot!")
        print("[INFO] Isi OWNER_ID dan ADMIN_IDS dengan Chat ID kamu.")
